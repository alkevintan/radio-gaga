#!/usr/bin/env bash
# Cut a Radio Gaga release. Bumps versionName/versionCode, builds, tags, pushes,
...
APK_DST="/tmp/RadioGaga-$VERSION.apk"
cp "$APK_SRC" "$APK_DST"
...
echo "or immediately via Settings → Updates → Check for updates."
