...
object UpdateChecker {
    ...
    suspend fun fetchLatest(context: Context): Release? = withContext(Dispatchers.IO) {
        val owner = context.getString(com.radio.player.R.string.update_github_owner)
        val repo = context.getString(com.radio.player.R.string.update_github_repo)
        ...
        val req = Request.Builder()
            ...
            .header("User-Agent", "RadioGaga-UpdateChecker")
            .build()
